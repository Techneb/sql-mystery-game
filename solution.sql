-- The Ritz Affair: reference path (seed 1912). One query per chapter; each answer is the next chapter's key.
...
-- 03. A Plate Beginning With 75-2 (LIKE) -> the plate (75-2 and three digits): 75-2041
