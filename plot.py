...
TEXT = {
 ...
 9: dict(
  ...
  telegram="MY DEAR CLERK STOP HIS LORDSHIP CARRIED THE STONE THROUGH CUSTOMS WITH A CLEAR CONSCIENCE STOP THE TICKET WAS BOUGHT BY A MAN IN GREY STOP YOU HAVE NEVER SEEN US TOGETHER STOP A L"),
 10: dict(
  title="Never Seen Together",
  story="The ticket was bought by a Mr. Grey. The Ritz knows a Mr. Grey: a quiet Englishman, excellent coat, who has stayed often since January. So has Mr. Blakeney. You have a suspicion of the theatrical kind: two names, one man, and a man cannot sleep in two suites on the same night. Among the regular guests, six stays or more, find the one who has never once been in the hotel on the same night as Blakeney. Beware: the Baron and Mr. Bell each crossed him for exactly one night, and one night is enough to be two people.",
